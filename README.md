...
- [Локальный UI](#4-локальный-ui-опционально)
...
- 🖥️ **Локальный UI** — веб-интерфейс для визуализации и работы с сетями
...
### 4. Локальный UI (опционально)

Для визуализации и интерактивной работы с сетями доступен веб-интерфейс:
...
Подробнее см. [UI_IMPLEMENTATION.md](UI_IMPLEMENTATION.md)
